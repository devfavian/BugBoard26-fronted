...
import application.view.common.IssuePriorityOption;
import application.view.common.IssueTypeOption;
...
public class ModifyIssueView extends BorderPane {
    ...
    private final ChoiceBox<IssueTypeOption> typeBox = new ChoiceBox<>();
    private final ChoiceBox<IssuePriorityOption> priorityBox = new ChoiceBox<>();
    ...
    public ModifyIssueView(IssueItem item) {
        ...
        typeBox.getItems().addAll(IssueTypeOption.values());
        typeBox.setValue(IssueTypeOption.fromApi(item.type()));

        priorityBox.getItems().addAll(IssuePriorityOption.values());
        priorityBox.setValue(IssuePriorityOption.fromApi(item.priority()));
    ...
    private void loadExistingImage() {
        ...
        AsyncRunner.run(task, preview::setImage, ex -> {});
    }
